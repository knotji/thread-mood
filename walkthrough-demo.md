...
- **Pristine Capture**: You can click the red **"ซ่อนแผง"** (Hide Panel) button to hide the control overlay entirely. A small eye icon (`👁️`) will float in the bottom-right corner to restore it whenever you need to switch states again.
- **Stable Layouts**:
